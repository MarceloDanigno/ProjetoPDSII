            ...
            getData('HTTP://localhost:3001/commuList')
                .then((data) => {
                    ...
                    for (const comm in data) {
                        ...
                        let prop1 = {title: currentPosts[0].postTitle, author: currentPosts[0].postAuthor,
                        ...
                        let prop2 = {title: currentPosts[1].postTitle, author: currentPosts[1].postAuthor,
                        ...
                        let prop3 = {title: currentPosts[2].postTitle, author: currentPosts[2].postAuthor,
